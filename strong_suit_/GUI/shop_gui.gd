...
func set_inventory(_inventory: Inventory) -> void:
	...
	items_shop_middle.set_items(inventory)
...
func _on_shop_menu_button_focused(button: BaseButton) -> void:
	...
	items_shop_middle.update_shop_labels(item)
...
func _on_options_button_focused(button: BaseButton) -> void:
	super(button)
	items_shop_middle.in_stock.text = "In Stock:"
	items_shop_middle.have.text = "Have:"
	match button.text.to_lower():
		"buy":
			items_shop_middle.set_items(inventory)
		"sell":
			items_shop_middle.set_items(Data.player_inventory)
		_:
			pass
